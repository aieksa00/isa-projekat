...
public class WebSecurityConfig {
    ...
    public WebSecurityCustomizer webSecurityCustomizer() throws Exception {
		return (web) ->
    	web.ignoring()
    	.antMatchers(HttpMethod.POST, "/UserCredentialsController/registreUserCredentials", "/emailController/sendMail",
    			"/BloodBankController/getFilteredBloodBanks", "/userController/addRegisteredUser", "/UserCredentialsController/logIn")
