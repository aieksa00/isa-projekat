package isaapp.g3malt.security;
...
public class TokenAuthenticationFilter extends OncePerRequestFilter {
	...
	public TokenAuthenticationFilter(TokenUtils tokenHelper, UserDetailsService userDetailsService, UserCredentialsService userCredentialsService) {
		...
		try {
			...
			if (authToken != null) {
				...
				if (username != null) {
					...
					if (tokenUtils.validateToken(authToken, userCredentials)) {
